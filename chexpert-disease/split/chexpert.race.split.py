...
disease_model = '/n/groups/patel/aashna/xray-dl/chexpert-disease/models/chexpert-disease-densenet-epoch=16-val_loss=0.28.ckpt'
...
def main(hparams):
    ...
    # data
    data = CheXpertDataModule(csv_train_img=f'../../data/splits/chexpert/chexpert.sample.train{sample}.csv',
    ...
    checkpoint_callback = ModelCheckpoint(monitor="val_loss", 
                                        ...
                                        filename= 'chexpert-disease-split-race-densenet-{epoch:02d}-{val_loss:.2f}',
