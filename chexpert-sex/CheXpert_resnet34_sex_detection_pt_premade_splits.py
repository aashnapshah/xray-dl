...
train_dataset = DatasetGenerator(train_path, '../../', 'GENDER', transform=train_transform) 
train_loader = DataLoader(train_dataset, batch_size=train_batch_size, shuffle=True, num_workers=32)

validate_dataset = DatasetGenerator(val_path,  '../../', 'GENDER', transform=validate_transform)
...
for epoch in range(num_epochs):
    ...
    if (val_loss < best_val_loss) or (val_accuracy > best_val_accuracy):
        ...
        arc_name = 'CHEXPERT_SEX_RESNET34_PY'
